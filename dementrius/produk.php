        ...
        <div class="container">
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a class="btn btn-primary px-4 fw-bold shadow-sm" href="tambah_produk.php"
                        ...
                        <table class="table table-hover align-middle m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="badge bg-light text-primary border"><?php echo $row['namakategori'] ?></span>
                                    </td>
                                    <td class="fw-semibold"><?php echo $row['namaproduk'] ?></td>
                                    <td class="text-success fw-bold">Rp <?php echo number_format($row['harga']) ?></td>
                                    <td class="small text-muted">
                                        <?php echo (strlen($row['deskripsi']) > 40) ? substr($row['deskripsi'], 0, 40) . '...' : $row['deskripsi']; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if($row['status'] == 1): ?>
                                        <span
                                            class="badge-status bg-success-subtle text-success border border-success-subtle">Aktif</span>
                                        <?php else: ?>
                                        <span
                                            class="badge-status bg-danger-subtle text-danger border border-danger-subtle">Tidak
                                            Aktif</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a title="Edit" href="edit_produk.php?id=<?php echo $row['idproduk'] ?>"
                                                class="btn btn-outline-warning btn-sm btn-action">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a title="Hapus" href="proses_hapus.php?idp=<?php echo $row['idproduk'] ?>"
