...
<head>
    ...
    <title>Produk | Nasya Store</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">Nasya Store</a>
    ...
    <section class="py-5">
        <div class="container">
            <div class="text-center mb-5">
                <h3 class="fw-bold">Store Tas Terpremium</h3>
                <p class="text-muted">Pilihan tas favorit pelanggan nasya store</p>
            </div>
