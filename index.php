        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['marco'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Marco</h4>
                        <a href="visit.php?toko=marco" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['alparani'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Alparani</h4>
                        <a href="visit.php?toko=alparani" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['andalas'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Andalas</h4>
                        <a href="visit.php?toko=andalas" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['ilham'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Ilham</h4>
                        <a href="visit.php?toko=ilham" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['sandi'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Sandi</h4>
                        <a href="visit.php?toko=sandi" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['shopi'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['nasya'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Nasya</h4>
                        <a href="visit.php?toko=nasya" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['yeni'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Yeni</h4>
                        <a href="visit.php?toko=yeni" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['dayat'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Dayat</h4>
                        <a href="visit.php?toko=dayat" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['median'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Median</h4>
                        <a href="visit.php?toko=median" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['dellam'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Della</h4>
                        <a href="visit.php?toko=dellam" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['david'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">David</h4>
                        <a href="visit.php?toko=david" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['jesika'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Jesika</h4>
                        <a href="visit.php?toko=jesika" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="800">
                <div class="card card-toko h-100 p-4">
                    <span class="visit-count">
                        <i class="bi bi-eye-fill me-1"></i>
                        <?php echo number_format($stats['arya'] ?? 0); ?>
                    </span>
                    <div class="text-center mt-3">
                        <div class="icon-circle"><i class="bi bi-lightning-fill"></i></div>
                        <h4 class="fw-bold mb-4">Arya</h4>
                        <a href="visit.php?toko=arya" class="btn btn-modern">Masuk Toko</a>
                    </div>
                </div>
            </div>
