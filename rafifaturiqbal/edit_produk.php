    ...
    <div class="section">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <select class="form-select" name="kategori" required>
                            ...
                            <option value="<?php echo $r['idkategori'] ?>"
                                <?php echo ($r['idkategori'] == $p->idkategori) ? 'selected' : ''; ?> "><?php echo $r['namakategori'] ?></option>
                        <?php }  ?>
                    </select>
                    <input type=" text" name="nama" class="form-control mt-3" placeholder="Nama Produk"
                                value="<?php echo $p->namaproduk ?>" required>
                                <input type="number" name="harga" class="form-control mt-3" placeholder="Harga Produk"
                                ...
                                <textarea name="deskripsi" class="form-control mt-3"
                                    placeholder="Deskripsi Produk"><?php echo $p->deskripsi ?></textarea>
        ...
        <footer>
            <div class="mt-5 bg-primary text-light p-3 text-center">
                <small>Copyright &copy; 2023 - Toko Rafi</small>
            </div>
        </footer>
