...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand fw-bold" href="dashboard.php">Toko Rafi</a>
        ...
        <div class="container">
            <div class="card welcome-card shadow mb-4">
                <div class="card-body p-5">
                    ...
                    <p class="lead">Anda berada di panel kendali Toko Rafi. Kelola dagangan Anda dengan mudah di sini.
                    </p>
                </div>
            </div>
    ...
    <footer class="bg-white border-top py-3 mt-auto">
        <div class="container text-center">
            <small class="text-muted">Copyright &copy; 2025 - <strong>Toko Rafi</strong>. All rights reserved.</small>
        </div>
    </footer>
